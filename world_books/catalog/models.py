...
class Author(models.Model):
    first_name = models.CharField(max_length=50, help_text='Введите имя автора', verbose_name='Имя автора')
    last_name = models.CharField(max_length=50, help_text='Введите фамилию автора', verbose_name='Фамилия автора')
    date_of_birth = models.DateField(help_text='Введите дату рождения автора', verbose_name='Дата рождения', blank=True, null=True)
    date_of_death = models.DateField(help_text='Введите дату смерти автора', verbose_name='Дата смерти', blank=True, null=True)
...
class Book(models.Model):
    ...
    description = models.CharField(max_length=1000, help_text="Введите краткое описание книги", verbose_name="Аннотация книги")
